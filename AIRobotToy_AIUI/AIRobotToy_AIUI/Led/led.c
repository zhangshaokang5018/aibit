...
void vLed_Task(void *pvParameters)
{
	...
	for(;;)
	{
		if (exucLED_Sta == 1)
		{
			...
			//红绿蓝
			//TIM_SetCompare1(TIM2, maxval/200 > 1000 ? 1000 : maxval/200);
			TIM_SetCompare2(TIM2, medval/200 > 1000 ? 1000 : medval/200);
			//TIM_SetCompare4(TIM2, minval/200 > 1000 ? 1000 : minval/200);
			vTaskDelay(50);
		}
